...
public class Signup3 extends JFrame implements ActionListener {
    ...
    Signup3(String formno){
        ...
        JLabel pd= new JLabel("YOUR 4 DIGIT PASSWORD");
        pd.setFont(new Font("Raleway", Font.BOLD,16));
        ...
        c7=new JCheckBox("I here by declares that the above details are correct to the bank of my knowledge");
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==submit){
            ...
            if(c1.isSelected()){
                ...
                facility=facility+"Mobile Number";
